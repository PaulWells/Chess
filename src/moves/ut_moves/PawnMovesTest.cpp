...
void PawnMovesTest::StartingPositionMoveTest(std::shared_ptr<Test> test)
{
    ...
    ChessPiece blackPawnHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, true, false);
    ChessPiece blackPawnHasJustDoubleJumped = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, true, true);
    board[1][1] = blackPawn;
...
{
    ChessBoard board = { 0 };
    ChessPiece whitePawnHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, true, false);
...
void PawnMovesTest::AttackTest(std::shared_ptr<Test> test)
{
    ChessBoard board = { 0 };
    ChessPiece whitePawnHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, true, false);
    ChessPiece blackPawn1 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, false, false);
    ChessPiece blackPawn2 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, false, false);
    board[5][1] = whitePawnHasMoved;
    Square whitePawnSquare = { 5, 1 };
...
void PawnMovesTest::EnPassantAttackTest(std::shared_ptr<Test> test)
{
    ChessBoard board = { 0 };
    ChessPiece whitePawnHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, true, false);
    ChessPiece blackPawnHasJustDoubleJumped1 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, true, true);
    ChessPiece blackPawnHasJustDoubleJumped2 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, true, true);
...
void PawnMovesTest::CantMoveIntoFriendlyPieceTest(std::shared_ptr<Test> test)
{
    ...
    ChessPiece whitePawn1 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, false, false);
    ChessPiece whitePawn2 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, false, false);
    ChessPiece whitePawn3 = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, false, false, false);
    board[5][1] = whitePawn;
    Square whitePawnSquare = { 5, 1 };
...
void PawnMovesTest::PromotionTest(std::shared_ptr<Test> test)
{
    ...
    ChessPiece blackPawnHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Pawn, true, true, false);
    ChessPiece blackQueenHasMoved = ChessPieceHelpers::MakeChessPiece(ChessPieceType::Queen, true, true, false);
